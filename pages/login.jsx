                            ...
                            <div className="lg:flex lg:flex-wrap g-0">
                                <div className="lg:w-6/12 px-4 md:px-0">
                                    <div className="md:p-12 md:mx-6">
                                        <div className="text-center">
                                            ...
                                            <h4 className="text-xl font-semibold mt-1 mb-12 pb-1">Welcome to Relier</h4>
                                        </div>
                                        <form>
                                            ...
                                            <div className="flex items-center justify-between pb-6">
                                                <a href="#" className="mb-0 mr-2 hover:text-blue-600">Don't have an account?</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                <div className="lg:w-6/12 flex items-center lg:rounded-r-lg rounded-b-lg lg:rounded-bl-none" style={{ background: 'linear-gradient(to right, #ee7724, #d8363a, #dd3675, #b44593)' }}>
                                    <div className="text-white px-4 py-6 md:p-12 md:mx-6">
                                        <h4 className="text-xl font-semibold mb-6">We are more than just a social network</h4>
                                        <p className="text-sm">
